    ...
    override func viewDidLoad() {
        ...
        SocketService.instance.getChatMessage { (newMessage) in
            if newMessage.channelId == MessageService.instance.selectedChannel?._id && AuthService.instance.isLoggedIn {
                ...
                self.scrollToLastMessageInTable()
...
//        }
        ...
        SocketService.instance.getTypingUsers { (typingUsers) in
            ...
            if numberOfTypers > 0 && AuthService.instance.isLoggedIn == true {
                ...
                self.typingUsersLabel.text = "\(names) \(verb)\(andOthers) typing a message..."
            } else {
        ...
        MessageService.instance.findAllChannel { (success) in
            if success {
                if MessageService.instance.channels.count > 0 {
                    ...
                    self.channelNameLbl.text = "Not channel yet!"
                }
            }
        }
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: "messageCell", for: indexPath) as? MessageCell {
            ...
            cell.comfigureCell(message: message)
            return cell
        } else {
    ...
    func scrollToLastMessageInTable() {
        if MessageService.instance.messages.count > 0 {
            let endIndex = IndexPath(row: MessageService.instance.messages.count - 1, section: 0)
            self.tableView.scrollToRow(at: endIndex, at: .bottom, animated: false)
        }
